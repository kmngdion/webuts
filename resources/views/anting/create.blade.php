...
@section('title', 'Tambah Anting')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/anting') }}">Anting</a></li>
    <li class="breadcrumb-item active">Tambah Anting</li>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h4 class="card-title">Form Tambah Anting</h4>
            </div>
        </div>
        <form action="{{ url('/anting') }}" method="POST">
            <div class="card-body">
                @csrf
                <div class="mb-3">

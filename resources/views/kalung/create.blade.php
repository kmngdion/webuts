...
@section('title', 'Tambah Kalung')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/anting') }}">Kalung</a></li>
    <li class="breadcrumb-item active">Tambah Kalung</li>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h4 class="card-title">Form Tambah Kalung</h4>
            </div>
        </div>
        <form action="{{ url('/kalung') }}" method="POST">
            <div class="card-body">
                @csrf
                <div class="mb-3">

...
@section('title', 'Tambah Gelang')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/gelang') }}">Gelang</a></li>
    <li class="breadcrumb-item active">Tambah Gelang</li>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h4 class="card-title">Form Tambah Gelang</h4>
            </div>
        </div>
        <form action="{{ url('/gelang') }}" method="POST">
            <div class="card-body">
                @csrf
                <div class="mb-3">
